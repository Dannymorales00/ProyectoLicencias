 ...
 * @author LeanPC
 */
public class ModificarOficiales extends javax.swing.JInternalFrame {
    
    private Oficial oficial;
    private ControladorOficiales contrOficial;
    /**
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        if (!this.txtCedula.getText().equals("")) {
            ...
            if (this.contrOficial.buscar(oficial)!=null) {
                oficial = this.contrOficial.buscar(oficial);
                
                this.txtCedula.setText(String.valueOf(oficial.getCedula()));
                this.txtCedula.setEditable(false);
                this.txtNombre.setText(oficial.getNombre());
                this.jDateChooser1.setDate(oficial.getFechanacimiento());
                this.txtTelefono.setText(String.valueOf(oficial.getTelefono()));
                this.txtCorreo.setText(oficial.getCorreo());
            ...
            JOptionPane.showMessageDialog(this, "Debe ingresar la cedula para carga el Oficial");
        }
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (oficial.comprobar()) {
            if(this.contrOficial.actualizar(oficial)){
                JOptionPane.showMessageDialog(this, "Oficial actualizado");
